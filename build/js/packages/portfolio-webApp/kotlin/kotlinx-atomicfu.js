(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).wt = function () {
    return this.vt_1.length;
  };
  ...
  protoOf(AtomicRef).xt = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).yt = function () {
  ...
  protoOf(AtomicInt).zt = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).yt = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicBoolean).au = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).yt = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).bu = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).yt = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).wt);
  //endregion
